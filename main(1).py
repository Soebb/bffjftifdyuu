...
chnls = "-1001516208383 -1001166919373 -1001437520825 -1658319171 -1001071120514 -1001546442991 -1001322014891 -1001409508844 -1001537554747 -1001462444753 -1001146657589 -1001592624165 -1001588137496"
        ...
        if (message.chat.id == -1001457054266):
            try:
                if "Ghermez" in media.file_name:
                    ...
                    await msg.copy(chat_id=-1437294321)
